...
import com.portfolio.moya.Dto.dtoExperiencia;
import com.portfolio.moya.Entity.Experiencia;
import com.portfolio.moya.Security.Controller.Mensaje;
import com.portfolio.moya.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp) {
        ...
        if (sExperiencia.existsByNombreE(dtoexp.getNombreE())) {
            return new ResponseEntity(new Mensaje("Esa experiencia ya exister"), HttpStatus.BAD_REQUEST);
        }
